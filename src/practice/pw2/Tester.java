...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            studentsGrades.sortIncrease();
            System.out.println("Students grades sorted in increase order : " + studentsGrades);
            studentsGrades.sortDecrease();
            System.out.println("Students grades sorted in decrease order : " + studentsGrades);
            Util.dashLine();
        }while(!toExit());
    }
